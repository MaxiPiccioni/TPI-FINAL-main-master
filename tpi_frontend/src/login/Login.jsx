...
import modalDialogService from "../components/services/modalDialog.service";
...
function Login() {
  ...
  const handleIngresar = async () => {
    try {
      ...
      modalDialogService.Alert("El Usuario ha sido logueado exitosamente.", "Operación exitosa");
    } catch (error) {
      modalDialogService.Alert("Error al loguear el usuario. Por favor, intente nuevamente.", "Error");
    }
  };
